        ...
        <div class="grid sm:grid-cols-2 gap-8">
          ...
          <div>
            <label class="text-slate-800 text-sm font-medium mb-2 block">Address</label>
             <textarea class="bg-slate-100 w-full text-slate-800 text-sm px-4 py-3 rounded focus:bg-transparent outline-blue-500 transition-all" placeholder="Enter Address" >
